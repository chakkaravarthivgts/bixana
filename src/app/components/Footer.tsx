    ...
    <footer className="relative w-full">
      ...
      <div className="bg-[#0052CC] px-8 lg:px-20 py-16">
        <div className="max-w-[1440px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-20">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-white text-[48px] font-light tracking-[-0.02em]">
                  bixana
                </h2>
              </div>
              <p className="text-white/90 text-[16px] leading-[1.6] font-normal">
                Bixana, A cloud application which helps dental clinic to keep better connect and continue relationship with patients
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                {["Home", "About Us", "Service", "Pricing", "Contact"].map((item) => (
                  <li key={item}>
                    <a
                      href="#"
          ...
          {/* Contact Info */}
          <div className="mt-16 space-y-2 text-white/70 text-[16px]">
