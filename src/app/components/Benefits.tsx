          ...
          {isMobile ? (
                ...
                {benefits.slice(0, 4).map((benefit) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <h3 className="text-[16px] font-light text-[#000000] leading-[1.4]">
                        {benefit.title}
                      </h3>
                    </div>
                  </div>
            ...
            <>
              ...
              <div className="flex flex-col items-center justify-between lg:flex-row  gap-8 lg:gap-12 mb-[200px]">
                ...
                {/* Right Images */}
                <div className="flex-1 max-w-[700px] w-full h-full flex flex-col gap-4">
                  {/* Upper Right Image */}
          ...
          {!isMobile && (
            ...
            >
              ...
              <BenefitCard
                ...
                className="xl:h-[264px] xl:w-[264px] xl:translate-x-[90px] 3xl:translate-x-[90px]"
                dataGsap="benefit-1"
              />
              ...
              <BenefitCard
                ...
                className="xl:h-[312px] xl:w-[376px]"
                dataGsap="benefit-2"
              />
              ...
              <BenefitCard
                ...
                className="xl:h-[210px] xl:w-[224px]"
                dataGsap="benefit-3"
              />
              ...
              <BenefitCard
                ...
                className="xl:h-[176px] xl:w-[176px]"
                dataGsap="benefit-4"
              />
              ...
              <BenefitCard
                ...
                className="xl:h-[192px] xl:w-[264px]"
                dataGsap="benefit-empty"
              />
              ...
              <BenefitCard
                ...
                className="xl:h-[280px] xl:w-[256px]"
                dataGsap="benefit-6"
              />
            </div>
          )}
